...
$mapping = [
    'CancellablePromiseInterface' => __DIR__ . '/CancellablePromiseInterface.php',
    'Deferred' => __DIR__ . '/Deferred.php',
    'FulfilledPromise' => __DIR__ . '/FulfilledPromise.php',
    'LazyPromise' => __DIR__ . '/LazyPromise.php',
    'Promise' => __DIR__ . '/Promise.php',
    'PromiseInterface' => __DIR__ . '/PromiseInterface.php',
    'PromisorInterface' => __DIR__ . '/PromisorInterface.php',
    'RejectedPromise' => __DIR__ . '/RejectedPromise.php',
