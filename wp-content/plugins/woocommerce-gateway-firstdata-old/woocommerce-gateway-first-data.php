...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.4.0', __( 'WooCommerce First Data Gateway', 'woocommerce-gateway-firstdata' ), __FILE__, 'init_woocommerce_gateway_first_data', array(
	...
	protected function get_change_gateway_link( $gateway ) {
		...
		switch ( $gateway ) {
			...
			case self::PAYEEZY_CREDIT_CARD_GATEWAY_ID:
				$gateway_name = esc_html__( 'Use Payeezy', 'woocommerce-gateway-firstdata' );
			break;
		}
