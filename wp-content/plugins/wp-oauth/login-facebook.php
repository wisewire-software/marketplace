...
define('SCOPE', 'email public_profile'); // PROVIDER SPECIFIC: 'email' is the minimum scope required to get the user's id from Facebook
define('URL_AUTH', "https://www.facebook.com/v2.7/dialog/oauth?");
define('URL_TOKEN', "https://graph.facebook.com/v2.7/oauth/access_token?");
define('URL_USER', "https://graph.facebook.com/me?fields=name,email");
...
function get_oauth_identity($wpoa) {
    ...
    $oauth_identity['full_name'] = $result_obj['name'];
