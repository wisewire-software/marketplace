...
define('URL_AUTH', "https://www.linkedin.com/oauth/v2/authorization?");
define('URL_TOKEN', "https://www.linkedin.com/oauth/v2/accessToken?");
define('URL_USER', "https://api.linkedin.com/v1/people/~:(id,email-address,first-name,last-name)?");
...
function get_oauth_identity($wpoa) {
	...
	$oauth_identity['full_name'] = $result_obj['firstName'] . ' ' . $result_obj['lastName'];
