...
<div class='wrap wpoa-settings'>
	...
	<div id="wpoa-settings-col1" class="wpoa-settings-column">
		<form method='post' action='options.php'>
			...
			<!-- START Login with Edmodo section -->
			<div id="wpoa-settings-section-login-with-edmodo" class="wpoa-settings-section">
				<h3>Login with Edmodo</h3>
				<div class='form-padding'>
					<table class='form-table'>
						<tr valign='top'>
							<th scope='row'>Enabled:</th>
							<td>
								<input type='checkbox' name='wpoa_edmodo_api_enabled' value='1' <?php checked(get_option('wpoa_edmodo_api_enabled') == 1); ?> />
							</td>
						</tr>
						...
						<tr valign='top'>
							<th scope='row'>Client ID:</th>
							<td>
								<input type='text' name='wpoa_edmodo_api_id' value='<?php echo get_option('wpoa_edmodo_api_id'); ?>' />
							</td>
						</tr>
						...
						<tr valign='top'>
							<th scope='row'>Client Secret:</th>
							<td>
								<input type='text' name='wpoa_edmodo_api_secret' value='<?php echo get_option('wpoa_edmodo_api_secret'); ?>' />
							</td>
						</tr>
					</table> <!-- .form-table -->
<!--					<p>-->
