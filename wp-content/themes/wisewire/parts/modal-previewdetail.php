...
<?php if (substr($item_preview,0,1) === 'Y') { ?>
    ...
    <?php if (($item_demo_viewer_template == "Carousel") || ($item_demo_viewer_template == "Iframe")) { ?>
        ...
        <div class="modal fade modal-preview<?php if ($item_demo_viewer_template == "Iframe") echo ' detail-iframe';?>" id="previewModal" tabindex="-1" role="dialog" aria-labelledby="previewModal">
