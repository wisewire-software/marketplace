<?php
/**
 * Template Name: Page For Edmodo Visitors
 */
...
.container-edmodo.forus-custom-color-4 {
...
.container-forus .edmodo-search-field .btn .icon {
...
.container-forus .edmodo-search-field .btn:focus {
   outline: 0;
}
</style>

<section class="container-edmodo forus-custom-color-4">
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <h3>Wisewire works seamlessly with your Edmodo account</h3>                
		<div class="forus-description">
                        <ul>
                                <li> You and your students can <a href="https://www.wisewire.com/user-login/" >login to Wisewire using your Edmodo login information</a></li>
                                <li> (Coming Soon) Wisewire practice quizzes can be assigned to your Edmodo classes</li>
                                <li> (Coming Soon) Scores from the quizzes will automatically appear in your Edmodo Progress Page</li>
                        </ul>
...
<section class="container-forus forus-custom-color-4">
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <h3>Search For High-Quality Computer-Based Assessments</h3>
                <div class="forus-description">
 Wisewire offers more than 10,000 premium and free high-quality formative assessments for a variety of subjects. Our assessments
are hands-on interactive questions that require students to demonstrate a thorough understanding of content. Innovative, evidence-centered items engage students at conceptual and strategic levels of thinking and prepare them for the rigors of high-stakes assessments. These can be used to support, remediate, or accelerate learning.
                </div>
              <div class="edmodo-search-field">
                <form role="search" method="get" id="searchform" class="searchform"
                action="<?php echo esc_url(home_url('/').'/explore/search/'); ?>">
                   <div class="input-group">
                      <input type="text" class="form-control home-search-input" name="search" placeholder="Search For High-Quality Assessments" >
