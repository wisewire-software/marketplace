...
<div class="container-fluid message-banner hidden-xs" style="background-color: #F1710C;position:abolute;top:0px;">
            <div class="row center-text" style="padding-right:5px;padding-left: 5px;padding-bottom: 5px;padding-top: 5px;z-index: 1000;background-color: #F1710C;">
                <h2 style="font-size: 16px;text-transform: uppercase;color: white;text-align:center;margin-top:3px;">
                <span style="text-transform: uppercase;font-size: 16px;color:white;text-align:center"> Our Free Course On Moving Online is
                    </span><a href="/moving-online/" style="color:white;font-size: 16px;margin-top:-5px;padding-top:5px;">Available Now</a></h2>
             </div>
    </div>

<div class="container-fluid message-banner visible-xs hidden-sm hidden-md hidden-lg" style="background-color: #F1710C; padding-left:0px;padding-right:0px;margin-left:0px;margin-right:0px; */z-index: 5000;">
            <div class="row center-text" style="margin-left:0px;margin-right:0px;padding-right:0px;padding-left: 0px;padding-bottom: 5px;padding-top: 0px; margin-top: 0px; /* position: absolute; *//* top: 65px; */z-index: 1000;/* background-color: rgba(255,255,255,0.66); */">
                <h2 style="font-size: 16px;text-transform: uppercase;color: white;margin-left:0px;margin-top:5px;margin-bottom:0px;margin-right:0px;text-align:center;"><!-- Transition Rapidly to Online Teaching with Confidence. -->
                <span style="text-transform: uppercase;font-size: 14px;color:white;text-align:center"> Our Free Course On Moving Online is
                    </span><a href="/moving-online/" style="color:white;font-size: 14px;margin-top:-2px;padding-top:2px;">Available Now</a></h2>
             </div>
    </div>
            ...
            <div class="col-sm-6 right-hero">
                <div class="right-hero-content">
                    ...
                    <div class="row" style="padding-left: 15px;padding-bottom: 15px;padding-top: 10px;margin-top: 0px;">
                       <h2 style="font-size:20pt;text-transform: uppercase;">Free Course On Moving Online <a href="/moving-online/" class="btn btn-pink" style="color:white;">Available Now</a></h2>
                    </div>
                </div>
            </div>
        </div> <!-- row -->
