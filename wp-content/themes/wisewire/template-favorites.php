        ...
        <div class="items-favorite">
          <div class="row">
            <div class="col-sm-3 col-nav">
              <div class="nav-head">
                <p>
                  <?php echo sizeof($favorites) ?> <?php echo sizeof($favorites) > 1 ? 'items' : 'item' ?> selected
                </p>
              </div>
              <div class="summary">
                <p>
              ...
              <section class="lo-items">
                ...
                <div class="row row-no-margin">
                    <?php if ($favorites): foreach ($favorites as $item): ?>
                        ...
                        <a href="?my_action=Favorites|action_remove&amp;item_id=<?php echo $item->id ?>&amp;item_type=question" title="Are you sure that you want to remove this from favorites?" class="btn-close btn-confirm"></a>
                      <?php else: ?>
                        <a href="?my_action=Favorites|action_remove&amp;item_id=<?php echo $item->item_object_id ?>" title="Are you sure that you want to remove this from favorites?" class="btn-close btn-confirm"></a>
                      <?php endif; ?>

					           <a class="lo-item lo-item-col <?php echo $WWItems->get_color($item->content_type_icon) ?>" href="/item/<?php echo($item->type == 'item' ? $item->name : $item->id) ?>/">
      ...
      <section class="lo-carousel lo-items">
        ...
        <div class="carousel">
          ...
          <div class="col-2-next">
            ...
            <a class="lo-item lo-item-col <?php echo $WWItems->get_color( $item_content_type_icon ) ?> <?php echo (substr($item_preview, 0, 1) === 'Y') ? 'has-preview' : '' ?>" href="<?php echo get_permalink($item) ?>">
              <div class="img">
          <?php
      ...
      <div class="mobile-accordion" id="lo-accordion-1" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
          <div class="panel-heading" role="tab" id="loItemHeading1">
            <h4 class="panel-title panel-summary">
              <a role="button" data-toggle="collapse" data-parent="#lo-accordion-1" href="#summarySection" aria-expanded="true" aria-controls="summarySection" class="collapsed">
                ITEM SUMMARY
              </a>
            </h4>
          </div>
          <div id="summarySection" class="panel-collapse collapse" role="tabpanel" aria-labelledby="loItemHeading1">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" role="tab" id="loItemHeading2">
            <h4 class="panel-title">
              <a role="button" data-toggle="collapse" data-parent="#lo-accordion-1" href="#loItem2" aria-expanded="true" aria-controls="loItem2" class="collapsed">
          ...
          <div id="loItem2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="loItemHeading2">
            <div class="panel-body">
			  <?php if ($favorites): foreach ($favorites as $item): ?>
              <article class="lo-item <?php echo $WWItems->get_color($item->content_type_icon) ?> <?php echo($item->type == 'item' ? '' : 'item-search') ?>" onclick="location.href='/item/<?php echo($item->type == 'item' ? $item->name : $item->id) ?>/'">
                <a href="?my_action=Favorites|action_remove&amp;item_id=<?php echo $item->item_object_id ?>&amp;item_type=question" title="Are you sure that you want to remove this from favorites?" class="btn-close btn-confirm"></a>
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-heading" role="tab" id="loItemHeading3">
            <h4 class="panel-title">
              <a role="button" data-toggle="collapse" data-parent="#lo-accordion-1" href="#loItem3" aria-expanded="true" aria-controls="loItem3" class="collapsed">
               recommended for you
              </a>
            </h4>
          </div>
          
          <div id="loItem3" class="panel-collapse collapse" role="tabpanel" aria-labelledby="loItemHeading3">
            <div class="panel-body">
