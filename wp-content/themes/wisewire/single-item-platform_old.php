...
?>
  ...
  <?php
	...
	// Load item
	$item = $wpdb->get_row("SELECT p.*, m4.`meta_value` AS `item_ratings` "
...
<?php
  ...
  $is_favorite = false; //$fav_controller->is_favorite($item_object_id, 'pod'); 
    ...
    <section class="detail detail-platform">
      ...
      <?php do_action('woocommerce_before_my_page'); // helloAri ?>
        ...
        <div class="metadata">
          ...
          <a href="/explore/<?php echo $grade ?>/<?php echo isset($item_discipline['slug']) ? $item_discipline['slug'].'/' : '' ?>">VIEW ALL <?php echo isset($item_discipline['name']) ? $item_discipline['name'] : '' ?></a>
      ...
      <div class="visible-xs-block">
            ...
            <div class="buttons">
              <p class="btn-contact">
                  <?php if ($item_contributor_id == '2186'): ?>
                    ...
                    <?php else: ?>
                      ...
                      <a href="#" class="btn btn-add-dashboard-not-loggedin" data-toggle="popover" data-content='
                 ...
                 <?php if ( is_user_logged_in() ): ?>
                      <!--<a href="<?php echo $item_preview_url; ?>" data-toggle="modal" data-target="#accessPlatformConfirm" class="btn">Add to dashboard</a>-->
                      <?php if($item_price == '0.00'){?>
                      <a href="/add-openstax?itemId=<?php echo $item_id; ?>&itemType=<?php echo $item_type ?>" target="_blank" class="btn">Add to dashboard</a>
                       <?php } ?>
              ...
              <?php if ( is_user_logged_in() ) { ?>
                ...
                <p class="btn-favorites">
                  ...
                  <a <?php echo $is_favorite ? '' : 'style="display: none;"' ?> href="?my_action=Favorites|action_remove&amp;item_id=<?php echo $item_object_id ?>&amp;item_type=question" data-item_type="question" data-item_id="<?php echo $item_object_id ?>" class="btn btn-alt btn-remove-favorite"
                     data-toggle="popover"
                     data-content='
                     <p class="info info-added">Item removed from favorites</p>
                     '>REMOVE FAVORITE</a>
                  
                  <a <?php echo !$is_favorite ? '' : 'style="display: none;"' ?> href="?my_action=Favorites|action_add&amp;item_id=<?php echo $item_object_id ?>&amp;item_type=question" data-item_type="question" data-item_id="<?php echo $item_object_id ?>" class="btn btn-alt btn-add-favorite"
                   data-toggle="popover"
                   data-content='
            ...
            <div class="contributor">
              <p>
                ...
                <?php if ($item_contributor_description != '') { ?>
                  <a href="#" data-toggle="modal" data-target="#contributorDetailsModal"><?php echo $item_contributor ?></a>
                <?php } else { ?>
              ...
              <div class="panel-body">  
                ...
                <div class="panel-content details-content-more">
                  ...
                  <dl class="dl-horizontal">
                    ...
                    <dt>License Type</dt>
                    <dd><?php echo $item_license_type ?></dd>
          <?php endif; ?>
        ...
        <div class="container">
          ...
          <ul class="post-nav">
			<?php if ($item_prev): ?>
			<li class="previous">
			  <a href="<?php echo get_permalink($item_prev[0]) ?>" data-toggle="tooltip" data-placement="right" title="<?php echo esc_html($item_prev[0]->post_title) ?>">&lt; previous IN THIS SERIES</a>
			</li>
			<?php endif; ?>

			<?php if ($item_next): ?>
			<li class="next">
			  <a href="<?php echo get_permalink($item_next[0]) ?>"  data-toggle="tooltip" data-placement="left" title="<?php echo esc_html($item_next[0]->post_title) ?>">next IN THIS SERIES &gt;</a>
			</li>
			<?php endif; ?>
		  </ul>
        ...
        <div class="accordion-style">
          ...
          <article class="lo-item <?php echo $WWItems->get_color($item->item_content_type_icon) ?>" onclick="location.href='<?php echo get_permalink($item) ?>';">
            <div class="content">
              <div class="details">
      ...
      <div class="hidden-xs">
        ...
        <div class="container">
          ...
          <div class="detail-info">
            ...
            <?php } ?>
            <div class="col">
              <div class="side-rate" style="<?php echo  ($item_contributor_id == '2186')? "margin-top:0":""; ?>">
                <?php rating_display_stars($item_ratings,'medium') ?>
                <span class="number rate-number"><?php echo $item_ratings ? $item_ratings : '' ?></span>
              </div>
              <?php if ( is_user_logged_in() ) { ?>
            ...
            <div class="clearfix">
              <div class="col col-left"> 
                <div class="option-logo">
        					...
        					<a href="<?php echo esc_url($item_contributor_website) ?>" class="btn" target="_blank">Website</a>
        					<?php endif; ?>
...
<?php else: ?>
    ...
    <section class="detail">
      ...
      <div class="container">
        ...
        <div class="metadata">
          ...
          <a href="/explore/<?php echo $grade ?>/<?php echo $item_discipline['slug'] ?>/">VIEW ALL <?php echo $item_discipline['name'] ?></a>
      ...
      <div class="visible-xs-block">
        ...
        <div class="container">
            <div class="img">
              ...
              <?php if ( ($item_demo_viewer_template == "Iframe") && ($item_object_url) ) { ?>
                <a href="#" class="btn-iframe" data-toggle="modal" data-target="#previewModalMerlot" data-src="<?php echo $item_object_url; ?>"><span class="icon"></span><img alt="" src="<?php echo $image[0]; ?>" class="img-responsive" /></a>
              <?php } else if (($item_demo_viewer_template == "PDF") && ($item_preview_pdf) ) { ?>
                <a href="<?php echo $item_preview_pdf; ?>" class="" target="_blank"><span class="icon"></span><img alt="" src="<?php echo $image[0]; ?>" class="img-responsive" /></a>
              <?php } else if (($item_demo_viewer_template == "Carousel") && ($item_carousel_images) ) { ?>
                <a href="#" class="" data-toggle="modal" data-target="#previewModalMerlot"><span class="icon"></span><img alt="" src="<?php echo $image[0]; ?>" class="img-responsive" /></a>
              <?php } ?>
            <?php } else { ?>
            ...
            <?php }  ?>
              ...
              <?php else: ?>
                <?php if (substr($item_preview,0,1) === 'Y') { ?>
                  <?php if ( ($item_demo_viewer_template == "Iframe") && ($item_object_url) ) { ?>
                    <a href="#" class="btn-iframe" data-toggle="modal" data-target="#previewModalMerlot" data-src="<?php echo $item_object_url; ?>"><span class="icon"></span><?php echo $WWItems->get_thumbnail($item_content_type_icon,'detail'); ?></a>
                  <?php } else if (($item_demo_viewer_template == "PDF") && ($item_preview_pdf) ) { ?>
                    <a href="<?php echo $item_preview_pdf; ?>" class="" target="_blank"><span class="icon"></span><?php echo $WWItems->get_thumbnail($item_content_type_icon,'detail'); ?></a>
                  <?php } else if (($item_demo_viewer_template == "Carousel") && ($item_carousel_images) ) { ?>
                    <a href="#" class="" data-toggle="modal" data-target="#previewModalMerlot"><span class="icon"></span><?php echo $WWItems->get_thumbnail($item_content_type_icon,'detail'); ?></a>
                  <?php } ?>
                <?php } else { ?>
                  <?php echo $WWItems->get_thumbnail($item_content_type_icon,'detail'); ?>
                <?php }  ?>
            ...
            <?php 
              ...
              ?>
              <?php if ( ($item_demo_viewer_template == "Iframe") && ($item_object_url) ) { ?>
                <a href="#" class="ribbon ribbon-xl btn-iframe preview_detail" data-toggle="modal" data-target="#previewModalMerlot" data-src="<?php echo $item_object_url; ?>"><span class="icon"></span> Preview</a>
              <?php } else if (($item_demo_viewer_template == "PDF") && ($item_preview_pdf) ) { ?>
                <a href="<?php echo $item_preview_pdf; ?>" class="ribbon ribbon-xl preview_detail" target="_blank"><span class="icon"></span> Preview</a>
              <?php } else if (($item_demo_viewer_template == "Carousel") && ($item_carousel_images) ) { ?>
                <a href="#" class="ribbon ribbon-xl preview_detail" data-toggle="modal" data-target="#previewModalMerlot"><span class="icon"></span> Preview</a>
              <?php } ?>
            <?php } ?>
           ...
           <?php } ?>
            ...
            <div class="buttons">
              ...
              <p class="btn-contact">
                ...
                <a href="<?php echo $item_preview_url; ?>" data-toggle="modal" data-target="#accessExternalConfirm" class="btn">Visit Website</a>
              ...
              <?php if ( is_user_logged_in() ) { ?>
                ...
                <p class="btn-favorites">
                  ...
                  <a <?php echo $is_favorite ? '' : 'style="display: none;"' ?> href="?my_action=Favorites|action_remove&amp;item_id=<?php echo $item_object_id ?>&amp;item_type=question&item_source=merlot"  data-item_source="merlot" data-item_type="question" data-item_id="<?php echo $item_object_id ?>" class="btn btn-alt btn-remove-favorite"
                     data-toggle="popover"
                     data-content='
                     <p class="info info-added">Item removed from favorites</p>
                     '>REMOVE FAVORITE</a>
                 
                  <a <?php echo !$is_favorite ? '' : 'style="display: none;"' ?> href="?my_action=Favorites|action_add&amp;item_id=<?php echo $item_object_id ?>&amp;item_type=question&item_source=merlot"  data-item_source="merlot" data-item_type="question" data-item_id="<?php echo $item_object_id ?>" class="btn btn-alt btn-add-favorite"
                     data-toggle="popover"
                     data-content='
                     <p class="info info-added">Item added to favorites</p>
                     '>ADD TO FAVORITES</a>
        ...
        <div class="mobile-accordion" id="mobile-accordion-1" role="tablist" aria-multiselectable="true">
          ...
          <dd><?php echo $item_publish_date; ?></dd>
                    ...
                    <a href="<?php echo $item_license_type_link; ?>" target="_blank"><?php echo $item_license_type; ?></a>
                    <?php } else { ?>
        ...
        <ul class="post-nav">
          ...
          foreach( $item_cms_previous_in_sequence as $post):  
            ...
            <li class="previous">
              <a href="<?php the_permalink(); ?>" data-toggle="tooltip" data-placement="right" title="<?php the_title(); ?>">&lt; previous IN THIS SERIES</a>
            </li>            
          ...
          foreach( $item_cms_next_in_sequence as $post):  
            ...
            <li class="next">
              <a href="<?php the_permalink(); ?>" data-toggle="tooltip" data-placement="left" title="<?php the_title(); ?>">next IN THIS SERIES &gt;</a>
            </li>            
        ...
        <div class="accordion-style"> 
          ...
          <article class="lo-item <?php echo $WWItems->get_color($post->item_content_type_icon) ?>" onclick="location.href='<?php echo get_permalink($post) ?>';">
            <div class="content">
              <div class="details">
                <h2 class="sub-discipline">
              ...
              <div class="content-title">
                ...
                <div class="content-type-icon">
                  <svg class="svg-<?php echo $WWItems->get_icon($post->item_content_type_icon) ?>-dims">
                    <use xlink:href="#<?php echo $WWItems->get_icon($post->item_content_type_icon) ?>"></use>
                  </svg>
                </div>
              </div>
            </div>
    ...
    <?php get_template_part('parts/modal', 'preview'); ?>    
        ...
        <div class="container">
          ...
          <?php foreach( $item_cms_related_items as $post):  
            ...
            <div class="col-sm-3 col-no-space col-2-next">
              ...
              <article class="lo-item lo-item-col <?php echo $WWItems->get_color($post->item_content_type_icon) ?>" onclick="location.href='<?php echo get_permalink($post) ?>';">
                <div class="img">
                <?php
  ...
  <?php if (substr($item_preview,0,1) === 'Y') { ?>
      ...
      <div class="modal fade modal-preview<?php if ($item_demo_viewer_template == "Iframe") echo ' detail-iframe';?>" id="previewModalMerlot" tabindex="-1" role="dialog" aria-labelledby="previewModalMerlot">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"></button>
