...
// License Type
  ...
  if ($item_license_type == 'CC-BY') {
    $item_license_type_link = 'http://creativecommons.org/licenses/by/4.0/';
  } else if ($item_license_type == 'CC-BY-SA') {
    $item_license_type_link = 'http://creativecommons.org/licenses/by-sa/4.0/';
  } else if ($item_license_type == 'CC-BY-ND') {
    $item_license_type_link = 'http://creativecommons.org/licenses/by-nd/4.0/';
  } else if ($item_license_type == 'CC-0') {
    $item_license_type_link = 'https://creativecommons.org/about/cc0';
  } else if ($item_license_type == 'Public Domain') {
    $item_license_type_link = 'http://fairuse.stanford.edu/overview/public-domain/welcome/';
        ...
        <div class="container">
            <div class="img">
              ...
              <?php if (substr($item_preview,0,1) === 'Y') { ?>
                  <?php if ( $item_demo_viewer_template == "Iframe" ) { ?>   
                      ...
                      <?php if ($item_object_url) : ?>             
                          <a href="#" class="btn-iframe" data-toggle="modal" style="<?php echo $inIframeAllowed? '':'cursor:default' ?>" data-target="<?php echo $inIframeAllowed? '#previewModal':'' ?>" data-src="<?php echo $item_object_url; ?>"><span class="icon"></span><img alt="" src="<?php echo $image[0]; ?>" class="img-responsive" /></a>
                      <?php else: ?>
                  ...
                  <?php } else if ($item_demo_viewer_template == "Carousel" ) { ?>
                      ...
                      <?php if ($item_carousel_images) : ?>
                          <a href="#" class="" data-toggle="modal" data-target="#previewModal"><span class="icon"></span><img alt="" src="<?php echo $image[0]; ?>" class="img-responsive" /></a>
                      <?php else: ?>
                          <img alt="" src="<?php echo $image[0]; ?>" class="img-responsive" />
                      <?php endif; ?>
              ...
              <?php else: ?>
                ...
                <?php if (substr($item_preview,0,1) === 'Y') { ?>
                    <?php if ( $item_demo_viewer_template == "Iframe" ) { ?>   
                        ...
                        <?php if ($item_object_url) : ?>  
                            <a href="#" class="btn-iframe" data-toggle="modal" style="<?php echo $inIframeAllowed? '':'cursor:default' ?>" data-target="<?php echo $inIframeAllowed? '#previewModal':'' ?>" data-src="<?php echo $item_object_url; ?>"><span class="icon"></span><?php echo $WWItems->get_thumbnail($item_content_type_icon,'detail'); ?></a>
                        <?php else: ?>
                    ...
                    <?php } else if ($item_demo_viewer_template == "Carousel" ) { ?>
                          ...
                          <?php if ($item_carousel_images) : ?>
                              <a href="#" class="" data-toggle="modal" data-target="#previewModal"><span class="icon"></span><?php echo $WWItems->get_thumbnail($item_content_type_icon,'detail'); ?></a>
                          <?php else: ?>
                              <?php echo $WWItems->get_thumbnail($item_content_type_icon,'detail'); ?>
                          <?php endif; ?> 
              ...
              <?php if ( ($item_demo_viewer_template == "Iframe") && ($item_object_url) && $inIframeAllowed ) { ?>
                <a href="#" class="ribbon ribbon-xl btn-iframe preview_detail" data-toggle="modal" data-target="#previewModal" data-src="<?php echo $item_object_url; ?>"><span class="icon"></span> Preview</a>
              ...
              <?php } else if (($item_demo_viewer_template == "Carousel") && ($item_carousel_images) ) { ?>
                <a href="#" class="ribbon ribbon-xl preview_detail" data-toggle="modal" data-target="#previewModal"><span class="icon"></span> Preview</a>
              <?php } ?>
            <?php } ?>
...
$(function(){
 ...
 <?php } else{  
                  ...
                  <p class="btn-contact">
                    <a href="<?php echo $item_cta_button_url; ?>" data-toggle="modal" data-target="#accessExternalConfirm" class="btn">Visit Website</a>
              ...
              <?php if ( is_user_logged_in() ) { ?>
                ...
                <p class="btn-favorites">
                  ...
                  <a <?php echo $is_favorite ? '' : 'style="display: none;"' ?> href="?my_action=Favorites|action_remove&amp;item_id=<?php echo $item_object_id ?>" data-item_id="<?php echo $item_object_id ?>" class="btn btn-alt btn-remove-favorite"
                     data-toggle="popover"
                     data-content='
                     <p class="info info-added">Item removed from favorites</p>
                     '>REMOVE FAVORITE</a>
                 
                  <a <?php echo !$is_favorite ? '' : 'style="display: none;"' ?> href="?my_action=Favorites|action_add&amp;item_id=<?php echo $item_object_id ?>" data-item_id="<?php echo $item_object_id ?>" class="btn btn-alt btn-add-favorite"
                     data-toggle="popover"
                     data-content='
