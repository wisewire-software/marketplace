...
if (WAN_TEST_ENVIRONMENT){
	...
	define('REDIRECT_LOCATION_DEMO','http://test-platform.wisewire.com/auth/favorite/');
	...
	define('REDIRECT_LOCATION_DEMO','https://platform.wisewire.com');
...
class Controller_Demo {
	...
	public function __construct($platform_demo_url, $type_request_page, $itemId='', $itemType='') {
		
		$this->redirect_location = 	REDIRECT_LOCATION_DEMO.$platform_demo_url;	
