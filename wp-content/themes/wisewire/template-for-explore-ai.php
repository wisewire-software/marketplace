...
<section class="ww_b2b bg_gray visible-sm visible-xs ww_b2b_sm_spacer" style="height:25px;">
    <div>
        <br />
    </div>
</section>
    ...
    <div class="ww_b2b ww_b2b_nopad visible-xs-block">
         ...
         <div class="tabs-list" id="tabs-list-1">
                    <div class="container">
                        ...
                        <h4><em>"Learning Science Prompt Engineering"</em></h4>
                    </div>
                </div><!-- /tabs-list -->
...
<section class="ww_b2b ww_b2b_txt_img bg_lightgray visible-xs-block">
...
<br>
            <div class="row">
                 ...
                 <div class="col-xs-12 col-sm-6 ww_b2b_txt_img">
                      <img src="/wp-content/themes/wisewire/img/b2b_pages/for-explore-ai/pexels-thisisengineering-3862627.jpg"
                                   class="img-responsive center-block" alt="..."style="max-width:300px;float:left;" >
                </div>
                <div class="col-xs-12 col-sm-6">
                    <h3 class="title-lightblue">Exploration and Testing</h3>
                    <p>At the heart of innovation, "Exploration and Testing" serve as the twin pillars guiding our
