<?php
/**
 * Template Name: Home Not Logged In Message Banner
 */
?>

<div class="container-fluid message-banner hidden-xs" style="background-color: #F1710C;z-index:1000;">
            <div class="row center-text" style="padding-right:5px;padding-left: 5px;padding-bottom: 5px;padding-top: 5px;z-index: 1000;background-color: #F1710C;">
                <h2 style="font-size: 16px;text-transform: uppercase;color: white;text-align:center;margin-top:3px;z-index:1000;">
